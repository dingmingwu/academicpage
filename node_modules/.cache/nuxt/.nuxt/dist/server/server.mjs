...
const _routes = [
  {
    name: "chan",
    path: "/chan",
    component: () => import("./nuxt_assets/chan-BA6wIoIy.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./nuxt_assets/index-DjSivMvy.js")
  },
  {
    name: "indexall",
    path: "/indexall",
    component: () => import("./nuxt_assets/indexall-DuPykqp5.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./nuxt_assets/error-404-Ct5biICg.js"));
    const _Error = defineAsyncComponent(() => import("./nuxt_assets/error-500-BFJ2j0dX.js"));
